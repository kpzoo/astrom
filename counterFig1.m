%% Two epidemics with OL convergence but CL divergence
clearvars; close all; clc; 

% Features and assumptions
% - reproduces Fig 1 of paper
% - control amplifies structural uncertainties
...
% Plotting and if want contiguous control
indivPlt = 0; contig = 1;
...
for ii = 1:lenID
    ...
    dis{ii} = getOLSynch(epiID(ii), fnt, indivPlt, contig);
